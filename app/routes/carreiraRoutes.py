...
from app.schemas.carreiraSchemas import CarreiraBase, CarreiraOut # schemas para validação de dados
from app.schemas.carreiraHabilidadeSchemas import CarreiraHabilidadeOut # schemas para validação de dados
...
from app.models.carreiraModels import Carreira # modelo de tabela definido no arquivo models.py
