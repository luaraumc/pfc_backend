from models import Carreira, setup_database # modelo da tabela e conexão com o banco de dados
from schemas import CarreiraBase, CarreiraOut # schema de dados
