...
from app.models.logExclusaoModels import LogExclusao # modelo da tabela de log de exclusões
from app.schemas.logExclusaoSchemas import LogExclusaoBase, LogExclusaoOut # schemas para validação e saída
